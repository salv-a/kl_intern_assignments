...
if name_shape == "1":
    print(shape_obj.circle_fntn())
elif name_shape == "2":
    print(shape_obj.triangle_fntn())
elif name_shape == "3":
    print(shape_obj.square_fntn())
elif name_shape == "4":
    print(shape_obj.rectangle_fntn())
elif name_shape == "5":
    print(shape_obj.cube_fntn())
elif name_shape == "6":
    print(shape_obj.cuboid_fntn())
elif name_shape == "7":
    print(shape_obj.sphere_fntn())
else:
